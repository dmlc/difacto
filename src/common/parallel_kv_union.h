#ifndef DIFACTO_COMMON_PARALLEL_KV_UNION_H_
#define DIFACTO_COMMON_PARALLEL_KV_UNION_H_
#include <vector>
#include "./parallel_kv_match.h"
namespace difacto {
 ...
 * key_b = {1,3,5};
 * val_b = {3,4,5};
 * ParallelKVUnion(key_a, val_a, key_b, val_b, &joined_key, &joined_val);
